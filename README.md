...
### 🎯 문제 상황
- 성인 전환기 이후 발달장애청년이 평일 낮 시간 대부분을 집에서 보내며,  
  지역사회 안에서 머물 일상적 공간과 관계망이 부족한 상황
- 보호자의 단독 돌봄 부담이 크고,  
  발달장애청년의 일상과 경험이 사회 전반에 충분히 공유되지 못하는 현실

### 💡 해결 아이디어
- 발달장애청년허브 **사부작**의 실제 활동과 서사를 바탕으로,  
  발달장애청년의 하루를 당사자 시점에서 플레이해보는  
  **웹 기반 인터랙티브 게임 〈경계없이, 다정하게〉**
- 플레이 구조:
...
- 어두운 집 안을 돌아다니며  
  **육아수첩, 일기장, 편지** 등 오브젝트를 클릭해 내용을 읽는 탐색형 구성.
- 사부작에서 실제로 나온 **보호자·청년의 문장**을 재구성하여 배치함으로써,  
  당사자와 보호자가 함께 겪는 정서와 상황을 간접적으로 체험할 수 있도록 설계.
- 졸업 이후의 공백, 보호자의 부담, 집에 머무를 수밖에 없는 현실 등을 통해  
  성인 발달장애청년의 **고립 구조를 ‘정보’가 아닌 장면으로 인식하게 하는 도입부 역할** 수행.

### 🌳 마을광장 & 미니게임 – 관계와 역할 체험
- **훌라 미니게임**  
  - 사부작 훌라 동아리 **‘선샤인아놀드훌라’**를 모티브로 한 구성.  
  - 말 중심 소통이 아닌, **함께 춤추는 몸의 경험**을 통해  
    발달장애청년의 **자기표현과 관계 형성 방식**을 보여주는 장면.

- **마을 공공시민노동 미니게임**  
  - 종이팩을 모아 교환하는 실제 **공공시민노동 활동**에서 가져온 설정.  
  - 쓰레기를 줍고, 분리배출을 돕고, 동네를 정돈하는 흐름을 통해  
    발달장애청년을 **일방적인 도움이 필요한 존재가 아니라 마을에 기여하는 주체**로 드러내는 구성.

- 전체적으로 플레이어가 NPC와의 대화와 퀘스트 수행을 통해  
  발달장애청년을 **“도와줘야 하는 대상”이 아닌, “함께 움직이며 마을을 살아가는 이웃”**으로 경험하도록 하는 단계.

### 🏪 옹호가게 & 엔딩 – 함께 사는 방식과 참여 경로
- 프롤로그에서 얻은 **옹호가게 쿠폰**을 들고 옹호가게를 처음 방문하는 장면으로 시작되는 전개.
- 실제 옹호가게 사례를 각색한 스토리를 기반으로,  
  가게 주인과 손님이 주인공을 **동네 사람 중 한 명**으로 자연스럽게 맞이하는 상호작용 구성.
- 옹호가게를 ‘특별한 시설’이 아니라  
  발달장애청년이 **자주 오고 가는 일상 공간**으로 보여줌으로써,  
  **함께 사는 마을의 구체적인 모습**을 제시.
- 엔딩 화면에서
  - **사부작 SNS**  
  - **카카오같이가치 후원 페이지**  
  로 이어지는 링크를 제공하여,  
